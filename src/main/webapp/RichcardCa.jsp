	    ...
	    <div class="row">
		  ...
		  <div class="form-group">
			...
			<input id="Template" type="email" class="form-control" id="email">
                 ...
                 <div class="col-md-6"  >
		  <div class="form-group">
			<label for="email"  >Imge Link</label>
			<input  type="email" class="form-control" id="URLimg" oninput="updateImage()">
		  </div>
		  </div>
          ...
          <input type="file" id="myfile" name="myfile">
           ...
           <div name="suggeston1"  >
                 ...
                 <div class="row">
               <div class="col-md-6">
                      <label for="email"> URL/Dial</label>
			  ...
			  <option value="URL">URL</option>
                ...
                <div class="form-group">
			<label for="email">  Suggestion Text</label>
			<input type="email" class="form-control"  id="Sugestion1I" oninput="Sugestion1IF()">
		  </div>
                       </div>
                 <div class="row">
                       <div class="col-md-6">
                <div class="form-group">
			<label for="email">Suggestion Postback</label>
			<input type="email" class="form-control" id="Suggestion_Postback">
		  </div>
                       </div>
              <div class="form-group">
        <label for="URL">URL/URI to open</label>
        <input type="text" id="URLsuggestion1"class="form-control" >
    </div>
            ...
            <br>
			  ...
			  <option value="Dial">Dial</option>
                ...
                <div class="form-group">
			<label for="email"> Suggestion Text</label>
			<input type="email" class="form-control" oninput="Sugestion2IF()" id="Sugestion2I">
		  </div>
                       </div>
                 <div class="row">
                       <div class="col-md-6">
                <div class="form-group">
			<label for="email">Suggestion Postback</label>
			<input type="email" class="form-control" id="Suggestion_Postback2">
		  </div>
                       </div>
                <div class="form-group">
